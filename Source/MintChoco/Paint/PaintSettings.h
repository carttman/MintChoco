 ...
 * grid is cut, how densely paint is stored, and the materials the bake uses. Per-surface choices
 * stay on the component and per-source choices on the brush profile; only what is the same
 * everywhere lives here. Everything is read once, when a surface begins play - nothing in here
